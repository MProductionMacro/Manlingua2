                           ...
                           VStack(spacing: 24) {
                              ForEach(story.subChapter, id: \.self){ subChapter in
                                  if storyId < singleton.latestStory {
                                      SubChapterCard(labelImage: .schoolChapter, chapter: "Bagian \(subChapter.id)", title: "\(subChapter.title)", pinyin: "\(subChapter.pinyin)", hanzi: "\(subChapter.hanzi)" ,isLocked: false, id: story.id, subChapter: subChapter)
                                         .padding(.horizontal)
                                  }
                                      ...
                                      SubChapterCard(labelImage: .schoolChapter, chapter: "Bagian \(subChapter.id)", title: "\(subChapter.title)", pinyin: "\(subChapter.pinyin)", hanzi: "\(subChapter.hanzi)" ,isLocked: true, id: story.id, subChapter: subChapter)
                                         .padding(.horizontal)
                                  }
