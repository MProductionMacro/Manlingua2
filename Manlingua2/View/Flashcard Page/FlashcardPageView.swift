        ...
        ZStack {
            VStack {
                ...
                if viewModel.showMicrophone{
                    ...
                    MicrophoneModalityView(responseText: $viewModel.apiResult, showMicrophone: $viewModel.showMicrophone){
                    ...
                    Wrong(hanzi: "ABCD", pinyin: "ABCD", meaning: "ABCD", viewModel: viewModel1, showMicrophone: $viewModel.showMicrophone){
                        viewModel.performSwipeRight()
                    }
                }
